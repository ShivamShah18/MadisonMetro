...
public class Bus implements Comparable<Bus> {
  ...
  public int compareTo(Bus other) {
    ...
    // If arrival times are equal, compare by routeAndTripName
    ...
    // If routeAndTripName is also equal, compare by direction
    BusRoute.BusDirection thisDirection = this.route.getDirection();
    BusRoute.BusDirection otherDirection = other.route.getDirection();

    return thisDirection.compareTo(otherDirection);
  }
